<div class="container-fluid pt-5 foot" style="overflow: hidden;">
		<div class="row footer">
			<div class="col-md-12 pt-3">
				<div class="row my-2">
					<div class="col-md-4 col-xs-12 p-4 wow fadeInUpBig">
						<div class="text-center pb-2">
						<img src="../assests/img/taalem-1080p.png" class="mx-auto" height="40" width="135" alt="Taalem Logo 1080"></div>	
					...
					<div class="col-md-4 col-xs-12 p-4 wow fadeInUpBig">
						...
						<ul class="ft-ql">
							<li><i class="fas fa-angle-right mr-2"></i><a href="#">About us</a></li>
		      ...
		      <div class="modal-body">
		      	<form action="" method="post">
		      		<div class="formgroup">
			      		...
			      		<input type="text" name="username" id="lgusername" class="form-control"  placeholder="Enter Username." onkeypress="return notSpace(event)" required />
		      		</div>
		      		<div class="formgroup">
					...
					<div>
						<h6 class="float-left mt-2">Forget password? Please <a href="" style="color:#f74040">click here.</a></h6>
