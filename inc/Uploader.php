...
class FileUpload {
    ...
    public $sizeLimit = 1073741824;         // Max file upload size in bytes (default 10MB)
    ...
    public function handleUpload($uploadDir = null, $allowedExtensions = null) {
        ...
        if ($this->fileExtension == "jpg" or $this->fileExtension == "png" or $this->fileExtension == "jpeg") {
            $this->fileName = "image-".uniqid()."-".time().".".$this->fileExtension;
        }else if($this->fileExtension == "mp4" or $this->fileExtension == "mkv"){
            $this->fileName = "video-".uniqid()."-".time().".".$this->fileExtension;
        }else{
            $this->fileName = "doc-".uniqid()."-".time().".".$this->fileExtension;
        }
