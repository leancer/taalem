$(function(){
        ...
        var secno = document.getElementById("nextsecno").innerHTML;
        console.log(secno);
        var nextID='';
        /*curriculum code*/
        //section code
        ...
        $('body').on('click','#delsec', function () {
            var idvala = $("#seccard").children("input:first").attr("id");
            var secval = $("#"+idvala).val();
        ...
        $("body").on("click",".addcnt",function(){
                    ...
                    var htmlcont = "<div id=\"div"+nextID+"\">";
                    htmlcont += "<div class=\"row\"><div class=\"col-md-6\"><input type=\"text\" id=\"contid" + nextID + "\" name=\"cntid[]\" value=\"0\" readonly><label>Enter Content Title</label>";
                    htmlcont += "<input type=\"text\" name=\"contname[]\" class=\"form-control\"><label>Enter Content Description(Optional)</label><input type=\"text\" name=\"contdesc[]\" class=\"form-control\"><a href=\"javascript:void(0);\" id='rem"+nextID+"' class=\"remcont\">Remove</a></div>";
                    ...
                    htmlcont += "<input type=\"text\" name=\"contfileurl[]\" id=\"contfileurlcrl" + nextID + "\" class=\"form-control\" readonly></div></div>";
                ...
                $("body").on('click','.remcont',function(){
                    ...
                    var cntid = $("#contid"+ currentid.substring(3)).val();
                    console.log(cntid);
            ...
            //preview video JS
            $("body").on('click','#prewvideocont > #uploadBtnvid',function(){
                ...
                // var lastItem = item.pop();
                // $('').remove();
                // $('#prewvideo').val(lastItem);

                

                // $('.input-value').html(lastItem + " Selected");
            ...
            //tumbnail image
            $("body").on("click","#prewimgcont > #uploadBtnimg",function(){

                    var btn = $(this);
                    var progressOutervid = $("#prewimgcont > #progressOuterimg");
                    console.log(progressOutervid);
                    ...
                    var msgBox = $("#msgBoximg");
                      ...
                      var uploader = new ss.SimpleUpload({
                            ...
                            onExtError: function() {
                                  //msgBox.innerHTML = ;
                                  $(msgBox).css('color','red');
                                $(msgBox).html('Invalid file type. Please select a jpg, jpeg, png, bmp.');
                              },
                              onProgress:function(pct){
                                //$(btn).val("Uploading...Please wait "+ pct);
                                $(progressBarvid).html(pct+'%');
